...
type App struct {
	Name               string `envconfig:"APP_NAME" default:"osoc"`
	...
	AppJWTSecret       string `envconfig:"APP_JWT_SECRET" default:"secret"`
	RefreshTokenSecret string `envconfig:"APP_REFRESH_TOKEN_SECRET" default:"refresh_secret"`
